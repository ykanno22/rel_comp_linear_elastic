...
% --->
if Flag.save == 1
    delete('prog3_truss_stress_analysis.log');
    diary( 'prog3_truss_stress_analysis.log');
end
%
param.eps  = 0.02;
param.delta = 0.01;
...
ylabel('Stress ($10^{6}$ Pa)', 'Interpreter', 'latex');
if Flag.save == 1
    print('-depsc2', '-painters', 'prog3_10bar_stress_bound');
end
% <---
% Figures
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if Flag.save == 1
    save( 'prog3_truss_stress_analysis.mat');
    diary off;
end
